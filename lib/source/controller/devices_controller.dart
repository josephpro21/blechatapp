...
class HomeController extends GetxController {
  ...
  /// on ready. The username is the model of the phone, start advertise and nearby device start.
  @override
  void onReady() async {
    super.onReady();
  ...
  void disconnectDevice({required String id}) async {
    try {
      ...
      Get.defaultDialog(
          title: "Could not disconnect properly",
          middleText:
